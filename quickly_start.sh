...
./hfd.sh showlab/ShowUI-desktop --dataset --local-dir ${DATABASE_DIR}/ShowUI-desktop

echo "------------>start ShowUI-web"
echo "./hfd.sh showlab/ShowUI-web --dataset --local-dir ${DATABASE_DIR}/ShowUI-web"

./hfd.sh showlab/ShowUI-web --dataset --local-dir ${DATABASE_DIR}/ShowUI-web
...
./hfd.sh KevinQHLin/ScreenSpot --dataset --local-dir ${DATABASE_DIR}/ScreenSpot
...
./hfd.sh Qwen/Qwen2.5-VL-7B-Instruct --local-dir ${WEIGHT_DIR}/Qwen2.5-VL-7B-Instruct
